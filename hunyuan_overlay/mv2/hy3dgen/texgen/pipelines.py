...
class Hunyuan3DTexGenConfig:
    ...
    def __init__(self, light_remover_ckpt_path, multiview_ckpt_path, subfolder_name):
        ...
        # assets_gen speed optimization: 1024 instead of 2048. The texture is baked
        # on CPU (Windows TDR workaround) so its cost scales with these sizes; 1024
        # is ample for the low-poly game assets this pipeline targets and saves ~5s
        # per generation. Env-overridable to restore 2048 if higher-res is needed.
